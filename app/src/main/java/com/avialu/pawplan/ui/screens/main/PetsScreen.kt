...
fun PetsScreen(
    ...
    Scaffold(
        ...
        Column(
            ...
            // ✅ אותו Header כמו Home
            GradientHeader(
                title = "Pets",
                subtitle = "Manage & upcoming"
            )
                    ...
                    items(state.pets) { pet ->
                        ...
                        AppCard(
                            ...
                            Text(
                                ...
                                color = if (pet.vaccinationEnabled) vaccineColor
                            ...
                            Text(
                                text =
                                    if (!pet.groomingEnabled) "✂️ Grooming: disabled"
                                    else if (nextGroom != null) "✂️ Next grooming: ${formatWhen(nextGroom)}"
                                    else "✂️ Next grooming: Not set",
                                color = if (pet.groomingEnabled) groomColor
                                else MaterialTheme.colorScheme.onSurfaceVariant
                            )
                        }
                    }
